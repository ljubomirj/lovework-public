...
def main():
    ...
    parts.extend([
        ...
        "",
        "Full listings are in `state/lj/wiki/reports/` and `state/lj/wiki/orgs/`.",
        "",
        "---",
        "",
        "## 3. Refresh now",
        ...
        "```",
        "",
        "**Re-distribute the agent skill** (after editing `agents/skills/lovework/SKILL.md`):",
        "",
        "```bash",
        "cd $LOVEWORK_ROOT",
        ...
        "",
        "All reports live under `state/lj/wiki/reports/`.",
        "",
        "---",
        "",
        ...
        "- `sync_skills.sh` — re-distributes the canonical `agents/skills/lovework/SKILL.md` to `.claude/skills/`, `.codex/skills/`, and the per-host Hermes path. Run after editing the canonical.",
        "- `cases.py` — lead → case helpers (`slug_for`, `make_case_dir`, `case_status`).",
        "",
        "**Skill distribution** (D16)",
        "- `agents/skills/lovework/SKILL.md` — canonical (single source of truth).",
